...
if (is.element(scale_factor_type, c(1,2,3,4))){
	...
	write.table(bg_fg_10_ncis, data_x_sig_norm_output_file+'.bg_fg_10.ncis.txt', quote=FALSE, col.names=FALSE, row.names=FALSE, sep='\t')
	...
	write.table(bg_fg_10_ncis, data_x_sig_norm_output_file+'.bg_fg_10.signorm_robust.txt', quote=FALSE, col.names=FALSE, row.names=FALSE, sep='\t')
