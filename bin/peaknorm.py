...
################################################################################################
###
def pknorm(wg_bed, peak_bed, sample_num, sig1_col_list, sig1_wg_raw, sig2_col_list, sig2_wg_raw):
	...
	plt.savefig(sig2_output_name + '.pknorm.scatterplot.pdf')
	...
	plt.xlim(lims_min, lims_max)
	plt.ylim(lims_min, lims_max)
	plt.savefig(sig2_output_name + '.scatterplot.pdf')
...
def main(argv):
	try:
		opts, args = getopt.getopt(argv,"hw:p:n:a:b:c:d:")
	...
	pknorm(wg_bed, peak_bed, sample_num, sig1_col_list, sig1_wg_raw, sig2_col_list, sig2_wg_raw)
