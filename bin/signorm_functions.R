...
t_r_curve_change_point = function(t_r_matrix, changepoint_method, t_r_change_point_plot_file_name){
	...
	png(t_r_change_point_plot_file_name)
	par(mfrow=c(1,2))
...
##############################################
calculate_scale_factor_with_t_thresh = function(data_x, data_y, sampling_num, t_threshold, scatterplot_MAplot_output_file_name){
