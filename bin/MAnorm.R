...
lines(c(bg_mean_read2, pk_mean_read2), c(bg_mean_read1, pk_mean_read1), col='black', lty=2, lwd=3)
...
lines(c(bg_mean_read2_rescaled, pk_mean_read2_rescaled), c(bg_mean_read1, pk_mean_read1), col='black', lty=2, lwd=3)
abline(0,1,lwd=3,col='black')
dev.off()
...
lines(c(bg_mean_read3, pk_mean_read3), c(bg_mean_read1, pk_mean_read1), col='black', lty=2, lwd=3)
abline(0,1,lwd=3,col='black')
dev.off()
...
lines(c(bg_mean_read4, pk_mean_read4), c(bg_mean_read1, pk_mean_read1), col='black', lty=2, lwd=3)
abline(0,1,lwd=3,col='black')
dev.off()
