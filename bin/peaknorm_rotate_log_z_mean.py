...
def pknorm(wg_bed, peak_bed, sample_num, sig1_col_list, sig1_wg_raw, sig2_col_list, sig2_wg_raw, upperlim, lowerlim):
	...
	plt.scatter(np.log2(sig2_norm_totalmean+small_num), np.log2(sig1_totalmean+small_num), marker='.', color='red')
	...
	plt.scatter(np.log2(sig2_totalmean+small_num), np.log2(sig1_totalmean+small_num), marker='.', color='red')
	plt.plot([lims_min, lims_max], [lims_min, lims_max], 'k', color = 'k')
